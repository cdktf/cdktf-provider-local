// https://registry.terraform.io/providers/hashicorp/local/2.4.1/docs
...
/**
* Represents a {@link https://registry.terraform.io/providers/hashicorp/local/2.4.1/docs local}
*/
export class LocalProvider extends cdktf.TerraformProvider {
  ...
  * @param importFromId The id of the existing LocalProvider that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/local/2.4.1/docs#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/local/2.4.1/docs local} Resource
  *
  * @param scope The scope in which to define this construct
