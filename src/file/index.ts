// https://registry.terraform.io/providers/hashicorp/local/2.4.1/docs/resources/file
...
export interface FileConfig extends cdktf.TerraformMetaArguments {
  ...
  *  Exactly one of these four arguments must be specified.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/local/2.4.1/docs/resources/file#content_base64 File#content_base64}
  */
  ...
  *  resource instead.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/local/2.4.1/docs/resources/file#sensitive_content File#sensitive_content}
  */
...
export class File extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing File that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/local/2.4.1/docs/resources/file#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/local/2.4.1/docs/resources/file local_file} Resource
  *
  * @param scope The scope in which to define this construct
