...
```go
import "github.com/cdktf/cdktf-provider-local-go/local/v5/sensitivefile"
...
| <code><a href="#@cdktf/provider-local.sensitiveFile.SensitiveFile.property.count">Count</a></code> | <code>*f64</code> | *No description.* |
...
| <code><a href="#@cdktf/provider-local.sensitiveFile.SensitiveFileConfig.property.count">Count</a></code> | <code>*f64</code> | *No description.* |
