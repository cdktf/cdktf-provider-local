...
# CDKTF prebuilt bindings for hashicorp/local provider version 2.4.0

This repo builds and publishes the [Terraform local provider](https://registry.terraform.io/providers/hashicorp/local/2.4.0/docs) bindings for [CDK for Terraform](https://cdk.tf).
